...
conn.sRevoke = '*[ ℹ️ ] El enlace del grupo ha sido restablecido.*';
...
await clearTmp()
console.log(chalk.bold.cyanBright('\n🟢 TMP 🟢\nARCHIVOS DE LA CARPETA TMP ELIMINADAS'))}, 1000 * 60 * 10)
...
console.log('✅PRESENCIA ENVIADA✅')}, 60000)*/
...
watchFile(file, () => {
unwatchFile(file)
console.log(chalk.bold.greenBright("SE ACTUALIZÓ 'main.js' CON ÉXITO"))
