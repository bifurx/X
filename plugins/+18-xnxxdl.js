...
if (!args[0]) return conn.reply(m.chat, `[❗] 𝙸𝙽𝙶𝚁𝙴𝚂𝙴 𝚄𝙽 𝙴𝙽𝙻𝙰𝙲𝙴 𝚅𝙰𝙻𝙸𝙳𝙾 𝙳𝙴 𝚇𝙽𝚇𝚇\n𝙴𝙹𝙴𝙼𝙿𝙻𝙾:\n${usedPrefix + command} https://www.xnxx.com/video-14lcwbe8/rubia_novia_follada_en_cuarto_de_bano*`, m)
  try {
        ...
        if (Array.isArray(global.videoListXXX) && global.videoListXXX.length > 0) {
          ...
          if (matchingItem) {
            if (index < matchingItem.urls.length) {
              ...
              m.reply(`𝙉𝙊 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙊. 𝙐𝙎𝙀 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀 𝙓𝙉𝙓𝙓 𝙔 𝙑𝙐𝙀𝙇𝙑𝘼 𝘼 𝙄𝙉𝙏𝙀𝙉𝙏𝘼𝙍`)
            }
          } else {
            m.reply(`𝙉𝙊 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙊. 𝙐𝙎𝙀 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀 𝙓𝙉𝙓𝙓 𝙔 𝙑𝙐𝙀𝙇𝙑𝘼 𝘼 𝙄𝙉𝙏𝙀𝙉𝙏𝘼𝙍`)
          }
    ...
    conn.sendMessage(m.chat, {video: {url: json.high}, fileName: res.result.title, mimetype: 'video/mp4', caption: `*🔞​RESULTADO🔞​*`, viewOnce: true});
  } catch {
    m.reply(`𝙉𝙊 𝙁𝙐𝙉𝘾𝙄𝙊𝙉𝙊. 𝙐𝙎𝙀 𝙐𝙉 𝙀𝙉𝙇𝘼𝘾𝙀 𝘿𝙀 𝙓𝙉𝙓𝙓 𝙔 𝙑𝙐𝙀𝙇𝙑𝘼 𝘼 𝙄𝙉𝙏𝙀𝙉𝙏𝘼𝙍`)
  }
};
