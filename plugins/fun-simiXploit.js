...
if (!text) return conn.reply(`INGRESE PREGUNTA O TEXTO`, m)
let syst = `Actuaras como un Bot de WhatsApp el cual fue creado por Anthony, tu seras Chester.`
if (command == 'bot') return conn.reply(m.chat, `Ya no es .bot\nMencione al bot al comienzo en lugar de poner .bot\n*Ejemplo:*\n\n@${conn.user.jid.split("@")[0]} Hola!`, m, { mentions: [conn.user.jid]})
if (command == '59898025027') {
try {     
...
handler.command = ['59898025027', 'bot', 'gemini']
handler.group = true
