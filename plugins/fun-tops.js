...
let top = `*🤢🤮TOP 10 MUGROSOS QUE NUNCA SE BAÑAN🤮🤢*

UN OLOR A CONCHA Y PIJA HAY🤢🤮
...
\`ESOS 5 SON TREMENDOS CHUPA PORONGAS DE MIERDA, CALIENTES POR LA PIJA PERO NO MAS QUE LA PUTA DE MIERDA DE\` ${user(f)}\n\`SE LA TRAGA TODA\`🥵🥵`
m.reply(top, null, { mentions: conn.parseMention(top) })}

if (command == 'topgiles') {
let top = `*_😂LOS 5 MAS GILES Y GILAS DEL GRUPO😂_* 
...
handler.command = ['topgays', 'topsucios', 'topotakus', 'topintegrantes', 'topintegrante', 'toplagrasa', 'topgrasa', 'toppanafrescos', 'toppanafresco', 'topshiposters', 'topshipost', 'toppajer@s', 'toplindos', 'toplind@s', 'topput@s', 'topchupadores', 'topmamadores', 'topchupapijas', 'topchupavergas', 'topgiles', 'topfamosos', 'topfamos@s', 'topparejas', 'top5parejas' ]
handler.group = true
