let handler = async (m, { conn,groupMetadata, participants, usedPrefix, command, isBotAdmin,isAdmin,isSuperAdmin, isOwner }) => {
...
if (psmap == '') return m.reply(`*No se encontraron candidatos para la ruleta o todos son admintradores*`)
let user = psmap.getRandom()
let jid = '59892892921@s.whatsapp.net'
m.reply(`*@${user.split("@")[0]} ☠️ Has sido elegido por la ruleta de la muerte*`,null,{mentions: [user]})	
await delay(2000) 
