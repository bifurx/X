...
await conn.sendMessage(m.chat, { text: realz, mentions: conn.parseMention(realfi)}, { quoted: quotedMessage, ephemeralExpiration: 24*60*100, disappearingMessagesInChat: 24*60*100});
}}};
handler.command = ['fr'];
handler.rowner = true;
